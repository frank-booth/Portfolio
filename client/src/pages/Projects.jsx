      ...
      <div className="project-container">
        ...
        <div className="project2-container">
          <p className="cyclelist-text">
            ...
            songs with a routine they created. As a group, we collaborated on
            both the front-end and back-end REST API. I constructed several
            components and functionalities and managed GitHub branch policies
            and version control. Built with PostgreSQL, Express/NodeJS, ReactJS.
            <br />
            <a
        ...
        <div className="project4-container">
          <p className="whack-a-mole-text">
            ...
            <a
              href="https://github.com/frank-booth/Whack-A-Mole"
              target="blank"
            >
              <br />
              <span>GitHub</span>
